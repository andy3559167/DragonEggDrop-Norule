package com.norule.dragoneggdrop.world;
...
import com.norule.dragoneggdrop.tasks.DragonCheckRunnable;
import com.norule.dragoneggdrop.tasks.RespawnRunnable;
...
public class EndWorldWrapper {
    ...
    protected EndWorldWrapper(@NotNull World world) {
        ...
        this.dragonCheckRunnable.runTaskTimerCompat(plugin.getTaskScheduler(), this.getSchedulerLocation(), 0L, 20L);
    }
    ...
    public boolean startRespawn(@NotNull DragonRespawnData respawnData, @NotNull DragonTemplate template, @Nullable DragonLootTable lootTable) {
        ...
        this.respawnTask.runTaskTimerCompat(plugin.getTaskScheduler(), this.getSchedulerLocation(), 0L, 20L);
        return true;
    }
    ...
    @NotNull
    private Location getSchedulerLocation() {
        World world = this.getWorld();
        DragonBattle battle = world.getEnderDragonBattle();
        Location endPortalLocation = battle != null ? battle.getEndPortalLocation() : null;
        return endPortalLocation != null ? endPortalLocation.clone() : new Location(world, 0.5D, 64.0D, 0.5D);
    }
